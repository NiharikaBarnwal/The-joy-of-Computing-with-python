...
im=Image.open("NPTEL/week10/grayscale-photograph.jpg").convert('L')   # .convert('L') ensures that the image is converted to grayscale
pixelMap = im.load()
...
img.save("NPTEL/week10/grayscale-photograph-2.jpg")
j=numpy.asanyarray(Image.open("NPTEL/week10/grayscale-photograph-2.jpg"))
print(j)